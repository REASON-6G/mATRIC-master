...
After performing those steps you should be able to open: http://dev.example.com and it will be served by your stack in `192.168.99.150`.
...
To simplify your Docker Compose setup, for example, so that the API docs (Swagger UI) knows where your API is, you should let it know you are using that domain for development.

* Open the file located at `./.env`. It will have a line like:
